  ...
  echo '<body>'.PHP_EOL;
     ...
     //echo ' <div class="masthead">'.PHP_EOL;
       echo ' <ul class="nav nav-pills pull-right">'.PHP_EOL;
         ...
         echo ' <li class ="active"><a href="index.php?option=users&view=list">Users</a></li>'.PHP_EOL;
...
function admins_renderLoginForm()
{
  if (!users_loggedIn()) {
    ...
    echo '  <input type="password" placeholder="password" name="password"/>'.PHP_EOL;
    echo '  <button type="button" class="btn btn-success">Login</button>                      '.PHP_EOL;
    echo '</form>                                                      '.PHP_EOL;
  }
    

  else{
    p("<h1>Welcome professor!</h1>");
    echo '<form action="index.php?option=courses&view=logout" method="post">                          '.PHP_EOL;
    echo '  <button type="button" class="btn btn-danger">Logout</button>                       '.PHP_EOL;
    echo '</form>                                                      '.PHP_EOL;
  }
